...
const Footer = () => {
  return (
    <footer>
        < hr/>
        <div>
            <div className=" text-secondaryDark text-center pt-20 p-2 text-md " >
            ...
            <div className=" text-primary flex justify-center items-center p-5">
                <input  type="text" className="outline-none border-b-2 border-dotted border-secondaryDark bg-primary" placeholder="Enter email" required></input>
            </div>
            ...
            <div className="text-secondaryDark text-center text-xs">
               <div className="flex justify-center items-center space-x-6 cursor-pointer font-bold  "> 
                ...
                <div className="flex justify-center items-center space-x-6 cursor-pointer text-secondaryDark  p-4">
            ...
            <div className="flex  justify-center items-center space-x-1 p-2 ">
                ...
                <p className="text-secondaryDark text-[10px]"> 2024  All rights reserved Privacy and Cookie Policy | Terms & Conditions | imprint</p>
            </div>
        </div>
