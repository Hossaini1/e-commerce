    ...
    <div className=" p-8  md:mt-14 sm:h-auto ">
      <div className=" max-w-[1400px] w-full md:w-[67vw] m-auto py-2 relative group">
        ...
        <div className="shadow-[0_0_10px] sm:rounded-xl sm:text-center sm:top-4 sm:left-3 sm:w-[12rem] sm:h-36 sm:p-4 md:w-[26rem] md:h-80 absolute md:bottom-[430px] md:left-7 md:top-7 md:rounded-3xl max-w-full sm:bg-tertiaryLight md:bg-tertiary flex justify-center items-center flex-col md:gap-5">
          <h2 className="sm:text-4xl sm:pb-1 text-primary font-bold md:text-7xl">
            Sale 20%
          </h2>
          <h4 className="sm:text-xl font-bold sm:text-primary sm:pb-2 md:text-3xl  text-primary">
            {slides[currentIndex].product}
          </h4>
          <Link
            to={`/${slides[currentIndex].category}`}
            className="shadow-[0_0_7px] hover:bg-secondaryDark hover:text-primary  sm:text-sm text-secondaryDark duration-700 md:text-2xl font-bold border-none bg-primary md:p-2 md:w-44 rounded-3xl sm:px-3 ease-in-out sm:py-[0.15rem] cursor-pointer"
          >
            Buy it
          </Link>
        </div>
          ...
          {slides.map((slide, slideIndex) => (
            <div
              ...
              className={`text-2xl cursor-pointer ${
                slideIndex === currentIndex ? "text-purple-400" : ""
              }`}
            >
              <RxDotFilled />
            </div>
